...
# Input for message
Label(root, text="Enter Your Message:", font=("Helvetica", 14)).pack(pady=6)
text_input = Text(root, height=6, width=60)
text_input.pack(pady=6)

# Input for key
Label(root, text="Enter Encryption Key:", font=("Helvetica", 14)).pack(pady=6)
key_input = Entry(root, show="*", width=60)
key_input.pack(pady=6)

# Buttons

Button(root, text="Encrypt", command=encrypt_message, bg="#F0E68C", font=("Helvetica", 12)).pack(pady=10)  # Light Khaki
Button(root, text="Decrypt", command=decrypt_message, bg="#AFEEEE", font=("Helvetica", 12)).pack(pady=10)  #Pale Turquoise

# Result display
Label(root, text="Output (Copyable):", font=("Helvetica", 14)).pack(pady=6)
result_output = Entry(root, font=("Helvetica", 14), width=60)
result_output.pack(pady=6)
